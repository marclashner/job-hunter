...
class Job(Base):
    ...
    salary_source: Mapped[str | None] = mapped_column(String(32), nullable=True)
    salary_quote: Mapped[str | None] = mapped_column(Text, nullable=True)
    eligible_countries: Mapped[list[str]] = mapped_column(JSONB, nullable=False, default=list)
